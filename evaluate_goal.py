...
import time
import torch
from torch_ac_goal.utils.penv import ParallelEnv
import argparse
import time
import datetime
...
eval_model_dir = utils_goal.get_model_dir(model_name)

# Load loggers and Tensorboard writer

txt_logger = utils_goal.get_txt_logger(eval_model_dir)
csv_file, csv_logger = utils_goal.get_csv_logger(eval_model_dir)
...
for i in range(args.procs):
    env = utils_goal.make_env(args.env, args.seed + 10000 * i)
    envs.append(env)
...
model_dir = utils_goal.get_model_dir(args.model)
agent = utils_goal.Agent(env.observation_space, env.action_space, model_dir, goal_generator=True,
