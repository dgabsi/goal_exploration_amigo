...
class Agent:
    ...
    def __init__(self, obs_space, action_space, model_dir,
        ...
        obs_space, self.preprocess_obss = utils_baseline.get_obss_preprocessor(obs_space)
        ...
        self.acmodel.load_state_dict(utils_baseline.get_model_state(model_dir))
        self.acmodel.to(device)
        self.acmodel.eval()
        if hasattr(self.preprocess_obss, "vocab"):
            self.preprocess_obss.vocab.load_vocab(utils_baseline.get_vocab(model_dir))
